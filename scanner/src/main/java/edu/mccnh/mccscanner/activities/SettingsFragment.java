...
public class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState)
    {
        ...
        excelFilePref.setSummary(FileHandling.stripColon(prefs.getString(MainActivity.KEY_PREF_PATH, "")));
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key)
    {
        switch (key)
        {
            case MainActivity.KEY_PREF_PATH:
                excelFilePref.setSummary(FileHandling.stripColon(sharedPreferences.getString(MainActivity.KEY_PREF_PATH, "")));
                break;
            default:
                break;
        }
